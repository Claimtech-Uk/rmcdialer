...
export function CallOutcomeModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <Card className="w-full max-w-md sm:max-w-2xl md:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-[90vw] max-h-[90vh] overflow-y-auto bg-white shadow-2xl border-0">
