  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        <h1 className="text-2xl font-bold mb-4">Welcome to RMC Dialler</h1>
        <p className="text-gray-600 mb-4">Please navigate to the queue to start making calls.</p>
        <a href="/queue" className="text-blue-600 hover:underline">Go to Queue</a>
      </div>
    </div>
  );
}
